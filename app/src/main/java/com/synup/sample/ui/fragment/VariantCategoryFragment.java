...
import com.synup.sample.ui.adapter.VariantCategoryAdapter;
...
public class VariantCategoryFragment extends BaseFragment implements IDataView, View.OnClickListener {

    private View variantCategoryView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        variantCategoryView = inflater.inflate( R.layout.variant_fragment_layout, container, false );
        initView();
        return variantCategoryView;
    }

    private void initView() {
        bRetry = Objects.requireNonNull(getActivity()).findViewById(R.id.retry);
        recyclerView = variantCategoryView.findViewById(R.id.recycler_id);
    ...
    public void onDataDownloadResponse(int eventId, List<VariantGroup> variantGroupData, List<List<ExcludeList>> excludeData) {
        if(eventId == Constants.RESULT_SUCCESS){
            ...
            VariantCategoryAdapter m_variantCategoryAdapter = new VariantCategoryAdapter(variantGroupData);
            recyclerView.setAdapter(m_variantCategoryAdapter);
